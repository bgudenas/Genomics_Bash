...
Logs = read.csv(args[2] )
annots$Tota_Reads = Logs$Total_Reads[match(annots$IDs, Logs$ID) ]
annots$Unique_Percent = Logs$Unique[match(annots$IDs, Logs$ID) ]
annots$Mapped_Percent = Logs$Total_Mapped[match(annots$IDs, Logs$ID) ]

annots %>% 
  DT::datatable(caption = "Samples")
```
